  ...
  return (
    <div className="px-[10%] shadow-stone-200 shadow-sm py-8 relative z-50 bg-white">
      <div className="flex justify-between items-center">
        ...
        {showMenu && (
          <div className="text-[#333366] shadow-sm shadow-stone-300 md:text-left text-center font-normal absolute md:hidden left-[10%] top-[110px] bg-white w-[80%] py-6 rounded-xl">
